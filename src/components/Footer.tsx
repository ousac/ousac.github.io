  ...
  return (
    <footer className="bg-ousac-blue py-6 text-white md:py-8">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mb-6 grid gap-8 border-b border-white/20 pb-6 md:mb-8 md:grid-cols-4 md:gap-12 md:pb-8">
          ...
          {/* Social Links */}
          <div>
            <h4 className="mb-6 text-sm font-bold tracking-wider text-white/90 uppercase">
              Connect
            </h4>
        ...
        <div className="flex flex-col items-center justify-center text-xs text-white/40 md:flex-row">
